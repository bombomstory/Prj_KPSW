...
<head>
  ...
  <title>แดชบอร์ดสำหรับครูที่ปรึกษา - โรงเรียนกำแพงแสนวิทยา</title>
...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          <li class="nav-item">
            <a class="nav-link" href="#" onclick="showStudentList()"><i class="bi bi-people"></i> นักเรียนในความดูแล</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#" onclick="showEvaluationStatus()"><i class="bi bi-check-circle"></i> สถานะการประเมิน</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#" onclick="showEvaluationReport()"><i class="bi bi-bar-chart"></i> รายงานผลประเมิน</a>
          </li>
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="advisorProfileDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
              <i class="bi bi-person-circle me-1"></i> 
              <?=$_SESSION['first_name'];?> <?=$_SESSION['last_name'];?>
            </a>
            <!--
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="advisorProfileDropdown">
  ...
  <section class="hero-section">
    ...
    <div class="container position-relative">
      <h1 class="display-5">แดชบอร์ดครูที่ปรึกษา</h1>
      <p class="lead">บริหารจัดการนักเรียนในความดูแลได้อย่างสะดวกและเป็นระบบ</p>
    </div>
  </section>

  <section class="container my-5">
    <div class="dashboard-container">
      <h3 class="mb-4 text-center">เมนูหลักสำหรับครูที่ปรึกษา</h3>
      <div class="menu-grid">
        <div class="menu-card" onclick="showStudentList()">
          <div class="menu-icon"><i class="bi bi-person-lines-fill"></i></div>
          <h5 class="menu-title">นักเรียนในความดูแล</h5>
          <p class="menu-description">ดูรายชื่อนักเรียน ตรวจสอบข้อมูลพื้นฐาน</p>
        </div>
        <div class="menu-card" onclick="showEvaluationStatus()">
          <div class="menu-icon"><i class="bi bi-clipboard-check"></i></div>
          <h5 class="menu-title">สถานะการประเมิน</h5>
          <p class="menu-description">ตรวจสอบว่านักเรียนในห้องประเมินเสร็จครบหรือไม่</p>
        </div>
        <div class="menu-card" onclick="showEvaluationReport()">
          <div class="menu-icon"><i class="bi bi-file-earmark-bar-graph"></i></div>
          <h5 class="menu-title">รายงานผลประเมิน</h5>
          <p class="menu-description">ดูสรุปผลประเมินครูจากนักเรียนแต่ละห้อง</p>
        </div>
        <div class="menu-card" onclick="showAnnouncements()">
          <div class="menu-icon"><i class="bi bi-megaphone"></i></div>
          <h5 class="menu-title">ประกาศแจ้งเตือน</h5>
          <p class="menu-description">แจ้งเตือนนักเรียนผ่านระบบหรือประกาศหน้าเว็บ</p>
        </div>
      </div>
    </div>
  </section>
            ...
            <div class="footer-content">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <p><i class="bi bi-envelope me-2"></i></i><a href='mailto:support@kpsw.ac.th'>support@kpsw.ac.th</a></p>
                    </div>
                </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="advisorModalTitle"></h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body" id="advisorModalBody"></div>
      </div>
    </div>
  </div>
  ...
  <script>
   ...
   function showAlert(message, type = 'info') {
    ...
    function showStudentList() {
      const content = `
        <ul class="list-group">
          <li class="list-group-item">ด.ช. ก้องภพ แก้วใส - ม.3/1</li>
          <li class="list-group-item">ด.ญ. วิภาวดี นาคดี - ม.3/1</li>
          <li class="list-group-item">ด.ช. ธนวัฒน์ ใจบุญ - ม.3/1</li>
        </ul>`;
      showModal('นักเรียนในความดูแล', content);
    }

    function showEvaluationStatus() {
      const content = `
        <div class="alert alert-info">นักเรียน 25 คน จาก 30 คน ทำการประเมินเรียบร้อยแล้ว (83%)</div>
        <ul class="list-group">
          <li class="list-group-item text-success">ด.ช. ก้องภพ - ✔️</li>
          <li class="list-group-item text-danger">ด.ญ. วิภาวดี - ❌</li>
          <li class="list-group-item text-success">ด.ช. ธนวัฒน์ - ✔️</li>
        </ul>`;
      showModal('สถานะการประเมินของนักเรียน', content);
    }

    function showEvaluationReport() {
      const content = `
        <table class="table table-bordered">
          <thead><tr><th>หัวข้อ</th><th>คะแนนเฉลี่ย</th></tr></thead>
          <tbody>
            <tr><td>ความเข้าใจในเนื้อหา</td><td>4.3</td></tr>
            <tr><td>การจัดการเรียนรู้</td><td>4.1</td></tr>
            <tr><td>การสื่อสารกับนักเรียน</td><td>4.4</td></tr>
          </tbody>
        </table>`;
      showModal('รายงานผลประเมินครูผู้สอน', content);
    }
    ...
    function showAnnouncements() {
      const content = `
        <form>
          ...
          <button type="submit" class="btn btn-primary">ส่งประกาศ</button>
        </form>`;
      showModal('ประกาศแจ้งเตือนนักเรียน', content);
    }
    ...
    function showSettings() {
      const content = `
        <form>
          <div class="mb-3">
            ...
            <input type="email" class="form-control" value="advisor@example.com">
          </div>
          <div class="mb-3">
      ...
      showModal('ตั้งค่าบัญชีผู้ใช้', content);
    }
    ...
    document.addEventListener('DOMContentLoaded', () => {
        showAlert('ยินดีต้อนรับสู่แดชบอร์ดครูที่ปรึกษา!', 'success');
    });
  </script>
</body>
</html>
